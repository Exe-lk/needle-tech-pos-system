...
const Navbar: React.FC<NavbarProps> = ({ className, onMenuClick }) => {
  ...
  return (
    <nav
      className={`bg-white dark:bg-slate-900 shadow-sm border-b border-gray-200 dark:border-slate-700 fixed top-0 left-0 right-0 z-40 h-[70px] w-full ${className}`}
    >
        ...
        <div className="flex justify-between items-center h-full">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 mr-1"
            >
              {isMobileMenuOpen ? (
                <X className="h-6 w-6" />
              ) : (
      ...
      {/* Mobile menu dropdown (currently only dark mode) */}
      {isMobileMenuOpen && (
